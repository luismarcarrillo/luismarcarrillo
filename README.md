...
Soy **Luismar Carrillo Álvarez**, estudiante de **Matemática Pura** en la **Universidad Nacional de Colombia (UNAL)**, con opción de doble titulación en **Ciencias de la Computación**.
...
Me motiva entender los fundamentos —las estructuras, los límites, las demostraciones— y luego utilizarlos como base para construir modelos, algoritmos y herramientas que aporten al conocimiento científico.
...
Inferencia, modelación probabilística, análisis de incertidumbre y fundamentos teóricos.

### 📐 Modelación matemática y cuantitativa
Matemática financiera, riesgo, series de tiempo y métodos aplicados.

### 🤖 Inteligencia Artificial y Machine Learning
Desde sus fundamentos matemáticos: optimización, teoría de la generalización y análisis del error.

### 💻 Programación científica y computación numérica
Python, R, métodos numéricos, simulación y diseño de experimentos computacionales.

### 📚 Investigación matemática básica
Interés en el desarrollo teórico y su impacto estructural en el conocimiento científico.


---

## 📎 Connect / Conecta
- 🔗 **CV (PDF):** https://example.com/luismar-cv.pdf  
- 🌐 **Website / Sitio web:** https://yourwebsite.com  
- 💼 **LinkedIn:** https://www.linkedin.com/in/luismar-carrillo-ds/  
- 🐦 **X (Twitter):** https://x.com/LuismarCarrill4
